...
function registerInMemoryCompiler(compiler) {
    ...
    compiler.hooks.done.tap(constants_1.MOCHAPACK_NAME, function (stats) {
        ...
        if (!stats.hasErrors()) {
            Object.keys(stats.compilation.assets).forEach(function (assetPath) {
                return assetMap.set((0, paths_1.ensureAbsolutePath)(assetPath, compiler.options.output.path), true);
            });
        }
    });
    ...
    var unmountHook = (0, registerRequireHook_1["default"])('.js', resolveFile);
