...
var createGetFile = function (requestShortener) { return function (e) {
    ...
    if (e.module &&
        ...
        return (0, formatUtil_1.stripLoaderFromPath)(e.module.readableIdentifier(requestShortener));
    }
...
var prependWarning = function (message) {
    return "".concat(chalk_1["default"].yellow('Warning'), " ").concat(message);
};
var prependError = function (message) { return "".concat(chalk_1["default"].red('Error'), " ").concat(message); };
function createStatsFormatter(rootPath) {
    ...
    var formatError = function (err) {
        ...
        if (file != null) {
            lines.push("in ".concat(chalk_1["default"].underline(file)));
            lines.push('');
        }
        else {
        ...
        lines.push((0, formatUtil_1.formatErrorMessage)(err.message));
