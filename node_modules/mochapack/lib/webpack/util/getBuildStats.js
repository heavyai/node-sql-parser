...
function getBuildStats(stats, outputPath) {
    ...
    var sortedChunks = (0, sortChunks_1["default"])(chunks, chunkGroups);
    var affectedModules = (0, getAffectedModuleIds_1["default"])(chunks, chunkGraph, modules, moduleGraph, builtModules);
    var entries = [];
    var js = [];
