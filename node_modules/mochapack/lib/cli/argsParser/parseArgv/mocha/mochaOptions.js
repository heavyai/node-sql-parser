...
var mochaOptions = {
    ...
    'reporter-option': {
        coerce: function (opts) {
            return (0, run_helpers_1.list)(opts).reduce(function (acc, opt) {
                var pair = opt.split('=');
                if (pair.length > 2 || !pair.length) {
                    throw (0, errors_1["default"])("invalid reporter option '".concat(opt, "'"), '--reporter-option', opt, 'expected "key=value" format');
                }
