 ...
 */
var pickParsedArgs = function (parsedArgs, options) { return (0, lodash_1.pick)(parsedArgs, Object.keys(options)); };
/**
...
var parseArgv = function (argv) {
    ...
    return {
        mocha: (0, parseMochaArgs_1.pruneMochaYargsOutput)((0, parseMochaArgs_1.parseMochaArgs)(argv)),
        webpack: webpack,
        mochapack: mochapack
    };
};
