...
var ensureNumericOptionsAreNumbers = function (camelizedArgs) {
    ...
    var output = (0, lodash_1.cloneDeep)(camelizedArgs);
...
var translateObjectIntoMochaOptions = function (args) {
    var oneToOnes = (0, lodash_1.omit)(args, argsThatDoNotDirectlyTranslateToMochaOptions);
    ...
    var options = (0, lodash_1.merge)({}, utils_1["default"].camelizeKeys(oneToOnes), {
...
var extractMochaConstructorOptions = function (parsedMochaArgs) {
    var relevantArgs = (0, lodash_1.omit)(parsedMochaArgs, exports.mochaCliOptionArgs);
    var mochaOptions = translateObjectIntoMochaOptions(relevantArgs);
    var mergedOptions = (0, mergeMochaConfigWithOptions_1.mergeMochaConfigWithConstructorOptions)(mochaOptions, parsedMochaArgs.config);
...
var extractMochaCliOptions = function (parsedMochaArgs) {
    var relevantArgs = (0, lodash_1.pick)(parsedMochaArgs, exports.mochaCliOptionArgs);
    var camelizedArgs = utils_1["default"].camelizeKeys(relevantArgs);
    var mergedOptions = (0, mergeMochaConfigWithOptions_1.mergeMochaConfigWithCliOptions)(camelizedArgs, parsedMochaArgs.config, parsedMochaArgs.opts);
    return mergedOptions;
};
/**
