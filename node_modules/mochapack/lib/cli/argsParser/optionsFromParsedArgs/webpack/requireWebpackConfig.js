...
var findConfigFile = function (dirPath, baseName) {
    for (var _i = 0, extensions_1 = extensions; _i < extensions_1.length; _i++) {
        ...
        var filePath = (0, path_1.resolve)(dirPath, "".concat(baseName).concat(extension));
...
var getConfigExtension = function (configPath) {
    ...
    return (0, path_1.extname)(configPath);
};
/**
...
var requireWithPrecompilerPath = function (configPath, configExtension) {
    var configDirPath = (0, path_1.dirname)(configPath);
    var configBaseName = (0, path_1.basename)(configPath, configExtension);
...
var findConfig = function (configPath, configExtension) {
    ...
    if ((0, fs_1.existsSync)(configPath)) {
        ...
        configFound = !(0, lodash_1.isUndefined)(requirePath);
    }
    if (configFound) {
...
var requireWebpackConfig = function (webpackConfig, required, env, mode) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                configPath = (0, path_1.resolve)(webpackConfig);
                configExtension = getConfigExtension(configPath);
                foundConfig = findConfig(configPath, configExtension);
                if ((0, lodash_1.isUndefined)(foundConfig) && required)
                    throw new Error("Webpack config could not be found: ".concat(webpackConfig));
                config = foundConfig
                    ? foundConfig["default"] || foundConfig
                    : {};
                if (!(0, lodash_1.isFunction)(config)) return [3 /*break*/, 2];
