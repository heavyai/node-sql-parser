...
var Mochapack = /** @class */ (function () {
    function Mochapack(options) {
        ...
        this.buildTestRunner = function () {
            ...
            (0, testRunnerReporter_1["default"])({
                eventEmitter: runner,
        ...
        this.options = (0, lodash_1.defaults)({}, this.options, this.defaultOptions);
    }
    /**
    ...
    Mochapack.prototype.addEntry = function (file) {
        this.entries = __spreadArray(__spreadArray([], this.entries, true), [file], false);
        return this;
    };
    /**
    ...
    Mochapack.prototype.addInclude = function (file) {
        this.includes = __spreadArray(__spreadArray([], this.includes, true), [file], false);
        return this;
    };
    /**
     * Run tests
