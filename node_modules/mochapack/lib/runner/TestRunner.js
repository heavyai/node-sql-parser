...
var TestRunner = /** @class */ (function (_super) {
    ...
    function TestRunner(entries, includes, options, cwd) {
        ...
        _this.createWebpackConfig = function () {
            return (0, createWebpackConfig_1["default"])({
                cwd: _this.cwd,
    ...
    TestRunner.prototype.prepareMocha = function (webpackConfig, stats) {
        var mocha = (0, initMocha_1["default"])(this.options.mocha, this.cwd);
        var outputPath = webpackConfig.output.path;
        var buildStats;
        if (webpack_1["default"].version[0] === '4') {
            buildStats = (0, webpack4GetBuildStats_1["default"])(stats, outputPath);
        }
        else {
            buildStats = (0, getBuildStats_1["default"])(stats, outputPath);
        }
        // @ts-ignore
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        failures = 0;
                        compiler = (0, createCompiler_1["default"])(config);
                        compiler.hooks.run.tapAsync(constants_1.MOCHAPACK_NAME, function (c, cb) {
                            _this.emit(constants_1.WEBPACK_START_EVENT);
                            cb();
                        });
                        dispose = (0, registerInMemoryCompiler_1["default"])(compiler);
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, , 4, 5]);
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                (0, registerReadyCallback_1["default"])(compiler, function (err, webpackStats) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        compiler = (0, createCompiler_1["default"])(config);
                        (0, registerInMemoryCompiler_1["default"])(compiler);
                        ...
                        watchCompiler = (0, createWatchCompiler_1["default"])(compiler, config.watchOptions);
                        ...
                        fileDeletedOrAdded = function (file, deleted) {
                            var matchesGlob = _this.entries.some(function (pattern) { return (0, minimatch_1["default"])(file, pattern); });
