    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, glob_1.glob)(entries, {
                        cwd: cwd,
                        absolute: true
                    })];
            case 1:
...
var makeTemporaryPath = function (cwd) {
    return (0, path_1.join)(cwd, '.tmp', constants_1.MOCHAPACK_NAME, Date.now().toString());
};
var getOutputPath = function (webpackConfig, tmpPath) {
    return (0, path_1.normalize)((0, lodash_1.get)(webpackConfig, 'output.path', tmpPath));
};
var getPublicPath = function (webpackConfig, outputPath) {
    return (0, lodash_1.has)(webpackConfig, 'output.path')
        ? (0, lodash_1.get)(webpackConfig, 'output.publicPath', undefined)
        : outputPath + path_1.sep;
};
var buildPluginsArray = function (webpackConfig, interactive) {
    var plugins = webpackConfig.plugins || [];
    if (interactive) {
        plugins.push((0, buildProgressPlugin_1.buildProgressPlugin)());
    }
    return plugins;
};
var buildLoaderRulesArray = function (options) {
    ...
    var loaderRules = (0, lodash_1.get)(webpackConfig, 'module.rules', []);
    loaderRules.unshift({
        test: entryPath,
        use: [
            {
...
var buildWebpackConfig = function (options) {
    return (0, lodash_1.merge)({}, options.webpackConfig, {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                mochapackWebpackConfig = buildWebpackConfig(__assign(__assign({}, options), { entryConfig: entryConfig, loaderRules: loaderRules, outputPath: outputPath, plugins: plugins, publicPath: publicPath }));
                return [2 /*return*/, {
